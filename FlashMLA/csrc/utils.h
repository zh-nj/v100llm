...
#if defined(__CUDA_ARCH__) && __CUDA_ARCH__ < 900 && defined(KERUTILS_ALLOW_SM70_STUB_COMPILE)
#define FLASH_MLA_LAUNCH_BOUNDS(THREADS, MIN_BLOCKS, CLUSTER_BLOCKS) __launch_bounds__(THREADS, MIN_BLOCKS)
#else
#define FLASH_MLA_LAUNCH_BOUNDS(THREADS, MIN_BLOCKS, CLUSTER_BLOCKS) __launch_bounds__(THREADS, MIN_BLOCKS, CLUSTER_BLOCKS)
#endif
