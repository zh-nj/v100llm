...
class SamplingParams(
    ...
    """If set to -1, use the truncation size supported by the model. If set
    to an integer k, use only the last k tokens from the prompt. If set to
    `None`, prompt truncation is disabled."""
