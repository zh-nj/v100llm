...
__global__ void __launch_bounds__(kThreadsPerBlock, 2)
  ...
  // RadixRowState for multi-CTA cooperative radix. It is zero-initialized
  // host-side via cudaMemsetAsync in topk.cu before launch, which gives a
  // stream-ordered happens-before edge for all CTAs.
