...
if(NOT (${CMAKE_CUDA_COMPILER_VERSION} VERSION_GREATER_EQUAL 12.8 AND QUTLASS_ARCHS))
...
elseif(QUTLASS_ARCHS MATCHES "12\\.[01][af]?")
  ...
  message(FATAL_ERROR "[QUTLASS] internal error parsing CUDA_ARCHS='${CUDA_ARCHS}'.")
endif()
